...
describe("Verify functionality under Clinic for Super Admin Role", () => {
  let loginData;
  before(() => {
  ...
  it("verify add organisation, edit clinic and delete clinic functionality", () => {
    ...
    //validating entering into organisation level
    //cy.visit('https://radindev.net/admin/organisation');
    //cy.visit('https://radindev.net/admin/rolesAndPermissions');
