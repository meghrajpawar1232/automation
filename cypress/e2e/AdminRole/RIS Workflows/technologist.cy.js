...
import TechnologistPage from "../../../pages/technologistPage";

const techno = new TechnologistPage();
...
describe("Verify the Functionality of Technologist page for Admin Role", () => {
  beforeEach(() => {
  ...
  it("Verify user should be able to CREATE new view, DUPLICATE, EDIT AND DELETE view in Technologist page", () => {
